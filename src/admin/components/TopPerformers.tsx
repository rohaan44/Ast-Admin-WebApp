    ...
    <Card className="bg-gray-900 border-gray-800 p-6">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold text-white">Migliori interpreti</h3>
        </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-800">
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Superiore</th>
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Allenatore</th>
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Atleti serviti</th>
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Reddito</th>
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-400">Stato</th>
            </tr>
          </thead>
          <tbody>
              ...
              <tr key={performer.rank} className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                ...
                <td className="py-4 px-4">
                  <Badge 
                    ...
                    className={performer.status === 'Active' 
