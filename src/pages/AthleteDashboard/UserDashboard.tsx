    ...
    <section className='w-full md:p-6 p-3'>
      <div className='flex flex-row items-start lg:items-center justify-between w-full gap-4 '>
        ...
        <div className='flex items-center gap-4 lg:w-auto'>
          ...
          <button className='hidden md:flex bg-[#151515] border border-[#FFFFFF0D] w-14 h-14 rounded-full items-center justify-center text-xl text-white hover:bg-[#252525] transition'>
            <BsBell />
          </button>
