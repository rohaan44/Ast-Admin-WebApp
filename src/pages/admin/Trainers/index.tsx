...
import { Search, Users, TrendingUp, FileText, Download, Plus, Eye, Edit, Trash2, Dumbbell } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4">
          <div className="max-w-[1800px] mx-auto space-y-4">
            {/* Page Header */}
            <div>
              <h1 className="text-2xl font-bold text-white mb-1">Gestione allenatori</h1>
              <p className="text-gray-400 text-sm">Gestire i coach certificati e le loro prestazioni.</p>
            </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-lg overflow-hidden">
              <div className="flex items-center justify-between p-4 border-b border-gray-800">
                <h2 className="text-lg font-semibold text-white">Elenco allenatori</h2>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-800/50">
                    <tr>
                      ...
                      <th className="text-left py-2 px-3 text-xs font-medium text-gray-400">Specializzazione</th>
                      <th className="text-left py-2 px-3 text-xs font-medium text-gray-400">Atleti serviti</th>
                      <th className="text-left py-2 px-3 text-xs font-medium text-gray-400">Reddito</th>
                  ...
                  <tbody>
                    {trainers.map((trainer) => (
                      <tr key={trainer.id} className="border-t border-gray-800 hover:bg-gray-800/30 transition-colors">
                        <td className="py-2 px-3">
                          <span className="text-white text-sm">{trainer.id}</span>
                        </td>
                        <td className="py-2 px-3">
                          <div className="flex items-center gap-2">
                            <img src={trainer.avatar} alt={trainer.name} className="w-7 h-7 rounded-full" />
                            <div>
                        ...
                        <td className="py-2 px-3">
                          <span className="text-gray-300 text-sm">{trainer.specialization}</span>
                        </td>
                        <td className="py-2 px-3">
                          <span className="text-white text-sm">{trainer.athletes}</span>
                        </td>
                        <td className="py-2 px-3">
                          <span className="text-white text-sm font-medium">{trainer.revenue}</span>
                        </td>
                        <td className="py-2 px-3">
                          <Badge 
                            className={`text-xs ${
